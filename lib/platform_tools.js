  ...
  compileAddon(addonSrcFile, options, cb) {
    ...
    addon.getDeps((err) => {
      ...
      this.compile(addonSrcFile, opt, (err) => {
        ...
        "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\amd64\link.exe" /ERRORREPORT:QUEUE /OUT:"C:\Users\jefe-win\repos\platform-tools\test\fixtures\sources\addons\build\Release\addon.node" /INCREMENTAL:NO /NOLOGO kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib DelayImp.lib "C:\Users\jefe-win\.node-gyp\6.2.1\Release\node.lib" Delayimp.lib /DELAYLOAD:iojs.exe /DELAYLOAD:node.exe /MANIFEST /MANIFESTUAC:"level='asInvoker' uiAccess='false'" /manifest:embed /MAP /MAPINFO:EXPORTS /OPT:REF /OPT:ICF /LTCG /TLBID:1 /DYNAMICBASE /NXCOMPAT /MACHINE:X64 /ignore:4199 /DLL Release\obj\addon\addon.obj
